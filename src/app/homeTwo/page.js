...
const homeTwo = [
  {
    id: "1",
    img: "https://i.ibb.co/Kht5XC3/homeimgtwo-1.jpg",
    name: "Become a morning person with the help of this a alarm clock",
    detail:
  ...
  {
    id: "2",
    img: "https://i.ibb.co/s3m91M4/homeimgtwo-2.jpg",
    name: "Why a balloon is a flexible bag that can be inflated with a gas",
    detail:
      "Nemo vel ad consectetur namut rutrum ex, venenatis sollicitudin urna. Aliquam erat volutpat. Integer eu ipsum sem. Ut bibendum lacus vestibulum maximus suscipit. Quisque vitae nibh iaculis neque blan...",
  },
];
    ...
    <div>
      <div className="lg:mx-40 max-sm:mx-4">
        <div className="flex justify-center lg:mt-20 max-sm:mt-4">
          <Image
            src="https://i.ibb.co/0Xqsrvq/home-Img-Two.jpg"
            width={1000}
            height={300}
            alt="homeImage"
      ...
      <div className="lg:flex lg:justify-center gap-20 lg:mx-40 max-sm:mx-4">
        {homeTwo.map((home) => (
          <div key={home.id}>
            <Image
              src={home.img}
